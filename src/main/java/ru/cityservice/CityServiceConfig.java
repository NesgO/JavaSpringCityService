...
@EnableWs
@Configuration
@ComponentScan("ru.cityservice")
public class CityServiceConfig extends WsConfigurerAdapter {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema citySchema) {
		...
		wsdl11Definition.setTargetNamespace(CityServiceEndpoint.namespaceUri);
